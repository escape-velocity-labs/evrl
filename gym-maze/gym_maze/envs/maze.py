...
class NormalMaze(Maze):

    def __init__(self) -> None:
        super().__init__(exploring_starts=False, shaped_rewards=False, size=5)


class RandomMaze(Maze):

    def __init__(self, size: int = 5) -> None:
        super().__init__(exploring_starts=True, shaped_rewards=False, size=size)


class ShapedRewardsMaze(Maze):

    def __init__(self, size: int = 5) -> None:
        super().__init__(exploring_starts=False, shaped_rewards=True, size=size)
